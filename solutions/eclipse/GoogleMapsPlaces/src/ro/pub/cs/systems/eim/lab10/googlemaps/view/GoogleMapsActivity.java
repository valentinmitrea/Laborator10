	...
	private class AddPlaceButtonListener implements Button.OnClickListener {
		...
		public void onClick(View view) {
			...
			if (latitudeContent == null || latitudeContent.isEmpty() || longitudeContent == null
					|| longitudeContent.isEmpty() || nameContent == null || nameContent.isEmpty()) {
				Toast.makeText(GoogleMapsActivity.this, "GPS coordinates / Name should be filled!", Toast.LENGTH_SHORT)
						.show();
				return;
			}
			...
			MarkerOptions marker = new MarkerOptions()
					.position(new LatLng(Double.parseDouble(latitudeContent), Double.parseDouble(longitudeContent)))
					.title(nameContent);
			marker.icon(BitmapDescriptorFactory
					.defaultMarker(Utilities.getDefaultMarker(markerTypeSpinner.getSelectedItemPosition())));
			googleMap.addMarker(marker);
			places.add(new Place(Double.parseDouble(latitudeContent), Double.parseDouble(longitudeContent), nameContent,
